...
/**
 * This job can be used to enter a weight measurement into Google Fit. The permissions to write
 * such data has to have been requested.
 * */
public class EnterWeightDataPointJob extends Job {

    private GoogleApiClient apiClient;
    private DataSet dataSet;

    public EnterWeightDataPointJob(GoogleApiClient googleApiClient, Context context, Date startTime, Date endTime, float weight){
