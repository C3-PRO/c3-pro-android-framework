...
public class ConditionalInstructionStep extends InstructionStep implements ConditionalStep, Serializable {
    protected List<ResultRequirement> requirements = new ArrayList<>();
     ...
     * @param detailText    Question text that is displayed to the user.
     */
    public ConditionalInstructionStep(String identifier, String title, String detailText, List<ResultRequirement> requirements) {
        super(identifier, title, detailText);
