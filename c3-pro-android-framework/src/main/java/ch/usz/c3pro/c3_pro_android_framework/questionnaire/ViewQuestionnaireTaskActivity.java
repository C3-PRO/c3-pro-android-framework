...
import ch.usz.c3pro.c3_pro_android_framework.pyromaniac.async.CreateIntentFromQuestionnaireAsyncTask;
...
/**
 * The ViewQuestionnaireTaskActivity has the same functionality as the ResearchStack
 * {@link org.researchstack.backbone.ui.ViewTaskActivity} but it can be created directly from a
 * FHIR Questionnaire. (The TaskViewActivity was not subclassed because some of the necessary
 * functions are declared private)
 * */
public class ViewQuestionnaireTaskActivity extends PinCodeActivity implements StepCallbacks
{
    public static final String EXTRA_TASK        = "ViewQuestionnaireTaskActivity.ExtraTask";
    public static final String EXTRA_TASK_RESULT = "ViewQuestionnaireTaskActivity.ExtraTaskResult";
    public static final String EXTRA_STEP        = "ViewQuestionnaireTaskActivity.ExtraStep";
    public static final String EXTRA_QUESTIONNAIRE_RESPONSE        = "ViewQuestionnaireTaskActivity.ExtraQuestionnaireResponse";
    ...
    /**
     * Get an {@link android.content.Intent} based on a FHIR {@link Questionnaire} which can be
     * started for a Result. The result will be a {@link QuestionnaireResponse} and can be read from
     * the Extras with the ID EXTRA_QUESTIONNAIRE_RESPONSE.
     * */
     ...
     * when ready.
     * */
    public static void newIntent(Context context, Questionnaire questionnaire, String requestID, Callback.IntentReceiver intentReceiver){
        new CreateIntentFromQuestionnaireAsyncTask(context, questionnaire, requestID, intentReceiver).execute();
    }
    ...
    private void saveAndFinish()
    {
        ...
        QuestionnaireResponse questionnaireResponse = Pyro.getTaskResultAsQuestionnaireResponse(taskResult);
        resultIntent.putExtra(EXTRA_QUESTIONNAIRE_RESPONSE, questionnaireResponse);
