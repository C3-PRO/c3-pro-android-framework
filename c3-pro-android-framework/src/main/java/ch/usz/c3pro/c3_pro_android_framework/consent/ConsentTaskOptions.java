...
public class ConsentTaskOptions {
    ...
    public String reviewConsentDocument;

    public boolean askToCreatePasscode = true;

    public boolean requiresSignature = true;



    public boolean requiresName = false;
    public boolean requiresBirthday = false;
